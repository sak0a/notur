...
### Frontend (Yarn workspaces: bridge + sdk)
```bash
yarn install
yarn build              # Build bridge + sdk
yarn build:bridge       # Build bridge runtime (webpack)
yarn build:sdk          # Build SDK (tsc)
yarn dev:bridge         # Watch mode for bridge

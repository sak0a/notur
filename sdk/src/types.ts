...
export type SlotId =
    ...
    | 'server.console.info.before'
    | 'server.console.info.after'
    | 'server.console.sidebar'
    | 'server.console.command'
    | 'server.console.footer'
    | 'server.files.actions'
    | 'server.files.header'
    | 'server.files.footer'
    | 'server.files.dropdown'
    | 'server.files.edit.before'
    | 'server.files.edit.after'
    | 'server.databases.before'
    | 'server.databases.after'
    | 'server.schedules.before'
    | 'server.schedules.after'
    | 'server.schedules.edit.before'
    | 'server.schedules.edit.after'
    | 'server.users.before'
    | 'server.users.after'
    | 'server.backups.before'
    | 'server.backups.after'
    | 'server.backups.dropdown'
    ...
    | 'dashboard.header'
    | 'dashboard.widgets'
    | 'dashboard.serverlist.before'
    | 'dashboard.serverlist.after'
    | 'dashboard.serverrow.name.before'
    | 'dashboard.serverrow.name.after'
    | 'dashboard.serverrow.description.before'
    | 'dashboard.serverrow.description.after'
    | 'dashboard.serverrow.limits'
    | 'dashboard.footer'
    | 'dashboard.page'
    | 'account.header'
    | 'account.page'

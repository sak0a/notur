...
class EnableCommandTest extends TestCase
{
    ...
    public function test_reports_already_enabled(): void
    {
        ...
        $this->artisan('notur:enable', ['extension' => 'acme/test'])
            ->expectsOutput("Extension 'acme/test' is already enabled.")
            ->assertExitCode(0);
    }

    public function test_fails_for_unknown_extension(): void
    {
        $this->artisan('notur:enable', ['extension' => 'unknown/extension'])
